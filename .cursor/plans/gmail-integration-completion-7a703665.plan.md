<!-- 7a703665-9fb7-4907-aa16-112a0e40b075 37a2b591-6fcc-468b-87c3-4b0c54fcf5f2 -->
...
- [x] Implement GmailClient.__init__ to load service account JSON and initialize httpx.AsyncClient
- [x] Implement GmailClient.ensure_token to create delegated credentials and refresh OAuth token
- [x] Implement GmailClient._request generic HTTP method with OAuth token injection
- [x] Implement GmailClient.list_history to fetch Gmail history changes
- [x] Implement GmailClient.get_message to fetch full Gmail message details
- [x] Implement process_gmail_webhook in domains/email/ingestion.py to orchestrate email processing
- [ ] Implement parse_gmail_message and create ParsedEmail Pydantic models in domains/email/parsing.py
- [ ] Implement classify_email and create EmailClassification models in domains/email/classification.py
- [ ] Update email router to call process_gmail_webhook and handle results
- [ ] Initialize FastAPI app in main.py, register routers, set up logging and health checks